...
class Notification_Screen extends StatefulWidget {
  ...
  Notification_Screen({Key? key, required this.notificationtype})
      : super(key: key);
...
class _Notification_ScreenState extends State<Notification_Screen> {
  ...
  void Init() async {
    ...
    if (preferences!.getString("accesstoken") != null) {
      ...
      profileprovider.fetchNotificationList(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: addMediumText(
            AppLocalizations.of(context)!.notificatin, 18, Colorss.mainColor),
        centerTitle: true,
        ...
        actions: [
          IconButton(
              ...
              onPressed: () async {
                var isDelete = await SettingRepository.deletenotification(
                    preferences!.getString("accesstoken").toString(),
                    "",
                    widget.notificationtype);
                if (isDelete) {
              ...
              icon: addLightText(
                  AppLocalizations.of(context)!.clear, 12, Colorss.mainColor)),
        ],
      ),
          ...
          child: Column(
            ...
            children: [
              ...
              Consumer<SettingProvider>(
                  builder: (context, settingProvider, child) => settingProvider
                              .notificationList?.data !=
                          null
                      ? settingProvider.notificationList!.data!.length > 0
                          ? ListView.builder(
                              itemCount: settingProvider
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                print("sdfsdf");
                                if (date.contains(settingProvider
                                    .notificationList!.data!
                                    .elementAt(index)
                                    .date)) {
                                  print(index);
                                  ...
                                  print("index $index");
                                  date = settingProvider.notificationList!.data!
                                      .elementAt(index)
                                      .date;
                                  print("date $date");
                                  ...
                                  var yesterday =
                                      outputFormat.format(yesterdaydate);
                                  print("utp $yesterday");
                                  if (settingProvider.notificationList!.data!
                                          .elementAt(index)
                                          .date ==
                                      today) {
                                    settingProvider.notificationList!.data!
                          ...
                          : Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SvgPicture.asset(
                                      "assets/images/brotherhood.svg"),
                                  SizedBox(
                                    height: 50.h,
                                  ),
                                  addBoldText(
                                      AppLocalizations.of(context)!
                                          .morechancegettingalike,
                                      11,
                                      Colors.black),
                                  SizedBox(
                                    height: 10.h,
                                  ...
                                  addRegularText(
                                      AppLocalizations.of(context)!.beactive,
                                      9,
                                      Colors.black),
                                  SizedBox(
                                    height: 40.h,
