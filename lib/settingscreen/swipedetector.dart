  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onPanUpdate: (DragUpdateDetails details) {
        ...
        if (details.delta.dx > 0 && details.globalPosition.dx >MediaQuery.of(context).size.width *0.20) {
          print("this is right direction");
        }

        // Swiping in left direction.
        if (details.delta.dx < 0 && details.globalPosition.dx <
                 MediaQuery.of(context).size.width *0.20) {
          print("this is left direction");
        }
      },
