...
class _Premium_ScreenState extends State<Premium_Screen> {
  ...
  Widget build(BuildContext context) {
    List<dynamic> planSlider=[
      {
        ...
        "title":AppLocalizations.of(context)!.preonet,
        "description":AppLocalizations.of(context)!.preoned,
      },
      {
        "icon":"${AppUrl.baseUrl}storage/plan/icons/3mQIh6iAHS5qIkXHELQZnoQBIvdaojBy3XPhSBLD.svg",
        "title":AppLocalizations.of(context)!.pretwot,
        "description":AppLocalizations.of(context)!.pretwod,
      },
      {
        "icon":"${AppUrl.baseUrl}storage/plan/icons/19hT3EtiGo35vhK4WKtLgOu0ler1FIoQjRxcj6a1.svg",
        "title":AppLocalizations.of(context)!.prethreet,
        "description":AppLocalizations.of(context)!.prethreed,
      },
      {
        "icon":"${AppUrl.baseUrl}storage/plan/icons/kI3b3R3vLzz7JUzCtfR4YxG5NMy5GxlLf4GyQv00.svg",
        "title":AppLocalizations.of(context)!.prefourt,
        "description":AppLocalizations.of(context)!.prefourd,
      },
      {
        "icon":"${AppUrl.baseUrl}storage/plan/icons/v0hDnLaTU1FXFRGdKoSOCWGgYXu5ge9NKofcRRzd.svg",
        "title":AppLocalizations.of(context)!.prefivet,
        "description":AppLocalizations.of(context)!.prefived,
      },
      {
        "icon":"${AppUrl.baseUrl}storage/plan/icons/bLWyzZg0RkYbL5mnbTgJqWZlPJ8WTtVeaClJKGHe.svg",
        "title":AppLocalizations.of(context)!.presixt,
        "description":AppLocalizations.of(context)!.presixd,
      },
      {
        "icon":"${AppUrl.baseUrl}storage/plan/icons/FiM2EYs0lWw7JkgClRTvVi9lMLXuJ9vE2HezJvhH.svg",
        "title":AppLocalizations.of(context)!.presevent,
        "description":AppLocalizations.of(context)!.presevend,
      },
      {
        "icon":"${AppUrl.baseUrl}storage/plan/icons/sdlPwFgYYD2VGLT9mTYXqwk4UyJ8OUxIOGFEeNMC.svg",
        "title":AppLocalizations.of(context)!.preeightt,
        "description":AppLocalizations.of(context)!.preeightd
      },
      {
        "icon":"${AppUrl.baseUrl}storage/plan/icons/bgUhG5pbPUwV2n87as114QXCUZmrcjF8QFN7Ohqt.svg",
        "title":AppLocalizations.of(context)!.preninet,
        "description":AppLocalizations.of(context)!.prenined
      },
      {
        "icon":"${AppUrl.baseUrl}storage/plan/icons/vl1QYooefqoZaFV68WkxxP5ryYIgSuPsS2mbPx0z.svg",
        "title":AppLocalizations.of(context)!.pretent,
        "description":AppLocalizations.of(context)!.pretend
      },
      {
        "icon":"${AppUrl.baseUrl}storage/plan/icons/N0DmfduwI2NedFY35ibow5pE4MXHGm7wLsfzWtHh.svg",
        "title":AppLocalizations.of(context)!.preelevent,
        "description":AppLocalizations.of(context)!.preelevend
      },
      {
        "icon":"${AppUrl.baseUrl}storage/plan/icons/4ShyA0PBdL8TCWD3OIHw0yiRSI335eSbLXABR7GA.svg",
        "title":AppLocalizations.of(context)!.pretwelvet,
        "description":AppLocalizations.of(context)!.pretwelved
      },
      {
        "icon":"${AppUrl.baseUrl}storage/plan/icons/pZYkpQIaEZwYZMJrbZzGbp5YjxluI4iKl4sHe958.svg",
        "title":AppLocalizations.of(context)!.prethreet,
        "description":AppLocalizations.of(context)!.prethreed
      }
    ];
    return Scaffold(
      ...
      //   child: Container(
      //     height: 8.h,width: 160.w,decoration: BoxDecoration(color: Colors.transparent,borderRadius: BorderRadius.circular(25.r)),),
      // ),
        ...
        child: Container(
          child: Column(
            children: [
                    ...
                    items: planSlider.map((images) {
                      ...
                      return Column(
                        children: [
                          ...
                          SizedBox(height: 15,),
                          addMediumText(images['title'], 14, Colorss.mainColor),
                          SizedBox(height: 15,),
                          SizedBox(
              ...
              //     builder: (context, settingprovider, child) => settingprovider.premiumListModel?.data != null?
              //     settingprovider.premiumListModel!.data!.length > 0 ?
              //     Column(
              //       children: [
              //         CarouselSlider(
              //           items: settingprovider.premiumListModel!.data!.map((images) {
              //             return Column(
              //               children: [
              //                 SvgPicture.network(
              //                   images.icon,
              ...
              //         Row(
              //           mainAxisAlignment: MainAxisAlignment.center,
              //           children: settingprovider.premiumListModel!.data!.asMap().entries.map((entry) {
              //             return GestureDetector(
              //               onTap: () => _controller.animateToPage(entry.key),
              //               child: _current == entry.key
              //                   ? Container(
              ...
              //         ),
              //       ],
              //     ):Center(child: Text(AppLocalizations.of(context)!.nopremium),):Center(child: CircularProgressIndicator(),)
              // ),
              SizedBox(height: 30,),
                  ...
                  child:Consumer<SettingProvider>(
                      builder: (context, settingprovider, child) {
                        if(settingprovider.premiumPlansModel?.data != null){
                          ...
                          {
                            _productLists =settingprovider.skulist;
                          }
                          print(settingprovider.premiumPlansModel!.subscription!);
                        ...
                        settingprovider.premiumPlansModel!.data!.length > 0
                            ? ListView.builder(
                          itemCount: settingprovider.premiumPlansModel!.data!
                              .length,
                          shrinkWrap: true,
                                ...
                                children: [
                                  Container(
                                    ...
                                    padding: EdgeInsets.symmetric(
                                        horizontal: 2.w, vertical: 5),
                                    child: Column(
                                      children: [
                                        addSemiBoldText(
                                            settingprovider.premiumPlansModel!
                                                .data!.elementAt(index)
                                                .invoicePeriod.toString(), 59,
                                            Colorss.mainColor),
                                        addMediumText(
                                            AppLocalizations.of(context)!.month,
                                            20, Colorss.mainColor),
                                        Text(
                                          "${settingprovider.premiumPlansModel!
                                              .data!.elementAt(index)
                                              .expectedPrice
                                              .toString()} ${settingprovider
                                              .premiumPlansModel!.data!
                                              .elementAt(index).currencySymbol
                                        ...
                                        addSemiBoldText("${settingprovider
                                            .premiumPlansModel!.data!.elementAt(
                                            index).price
                                            .toString()} ${settingprovider
                                            .premiumPlansModel!.data!.elementAt(
                                            index).currencySymbol.toString()}",
                                            14, Colorss.mainColor),
                                        addMediumText("${settingprovider
                                            .premiumPlansModel!.data!.elementAt(
                                            index).per_month_price
                                            .toString()} ${settingprovider
                                            .premiumPlansModel!.data!.elementAt(
                                            index).currencySymbol.toString()}",
                                            11, Color(0xFFCCCCCC)),
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          addMediumText("${settingprovider
                                              .premiumPlansModel!.data!
                                              .elementAt(index).per_month_price
                                              .toString()} ${settingprovider
                                              .premiumPlansModel!.data!
                                              .elementAt(index).currencySymbol
                                              .toString()}", 11,
              ...
              !isLoad?InkWell(
                ...
                child: Container(
                    ...
                    alignment: Alignment.center,
                    child: addMediumText(AppLocalizations.of(context)!.buypremium, 14,Color(0xFFFFFFFF) )
                ),
...
extension InAPPPurchaseMethods on _Premium_ScreenState {
  ...
  Future<void> initPlatformState() async {
    ...
    _purchaseUpdatedSubscription =
        FlutterInappPurchase.purchaseUpdated.listen((productItem) async {
          ...
          print('purchase-updated: ${plan_id}');
          print('purchase-updated: ${productItem?.productId}');
          ...
          print(paymentsucess.statusCode);
          if(paymentsucess.statusCode==200)
          {
            var model=await ProfileRepository.updateProfile("premium", "user_plan", preferences!.getString("accesstoken")!);
            if(model.statusCode==200)
            {
              setState(() {
                isLoad=false;
              });
              preferences!.setString("usertype", "premium");
              var provider=await Provider.of<ProfileProvider>(context,listen: false);
              provider.resetStreams();
              provider.user_type="premium";
