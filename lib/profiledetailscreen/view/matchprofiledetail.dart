...
class MatchProfileDetailScreen extends StatefulWidget {
  String user_id = "";
  MatchProfileDetailScreen({required this.user_id});
  @override
                                                    ...
                                                    children: [
                                                      GestureDetector(
                                                        onTap: () async {
                                                          ...
                                                          if (profileProvider
                                                              .activemonogomy) {
                                                            var isdislike = await DashboardRepository
                                                                .userdislike(
                                                                    preferences!
                                                                        .getString(
                                                                            "accesstoken")!,
                                                            ...
                                                            if (isdislike
                                                              ...
                                                              List<UserDatum>?
                                                                  matchuserList =
                                                                  await DashboardRepository.getLikeUserList(
                                                                      preferences!
                                                                          .getString(
                                                                              "accesstoken")!,
                                                                      1,
                                                              ...
                                                              var profileprovider =
                                                                  Provider.of<
                                                                      ...
                                                                      listen:
                                                                          false);
                                                              var mongonomystart =
                                                                  await DashboardRepository.monogonomystop(
                                                                      preferences!
                                                                          .getString(
                                                                              "accesstoken")!,
                                                                      widget
                                                      ...
                                                      GestureDetector(
                                                        onTap: () async {
                                                          ...
                                                          bool? chat = await profileProvider.userChatOrNot(
                                                          ...
                                                          if (chat == true) {
                                                            if (profileProvider
                                                              ...
                                                              print(
                                                                  "======>>>>>>$newIndex");
                                                              print(
                                                                  "heloo ${profileProvider.userprofiledetails?.data?.email}");
                                                              if (newIndex ==
                                                                  null) {
                                                                print("heloo");
                                                                createAccountWithEmail(
                                                                  ...
                                                                  for (int i =
                                                                      ...
                                                                      i <
                                                                          docSnap
                                                                              ...
                                                                              .length;
                                                                      i++) {
                                                                    if (profileProvider.userprofiledetails?.data?.email ==
                                                                            docSnap.docs[i][
                                                                                'nickname'] ||
                                                                        profileProvider.userprofiledetails?.data?.email.toString().toLowerCase() ==
                                                                  ...
                                                                  Get.to(ChatPage(
                                                                      arguments: ChatPageArguments(
                                                                          conversationName: (profileProvider
                                                                              .userprofiledetails
                                                                              ?.data
                                                                              ?.name),
                                                                          peerId: docId ??
                                                                              "",
                                                                          otherUserId: (profileProvider
                                                                              .userprofiledetails
                                                                              ?.data
                                                                              ?.id),
                                                                          peerAvatar: (profileProvider
                                                                              .userprofiledetails
                                                                              ?.data
                                                                              ?.profile_image),
                                                                          peerNickname: (profileProvider
                                                                              .userprofiledetails
                                                                              ?.data
                                                                              ?.email),
                                                                          chatEnable:
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: isLoad
                                                              ...
                                                              : SvgPicture
                                                                  .asset(
                                                                  "assets/images/usersendicon.svg",
                                                                  color: Colors
                                                                      .white,
                                                                  height: 25.h,
                                                                  width: 25.w,
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: <
                                                                      ...
                                                                      GestureDetector(
                                                                          ...
                                                                          child: addMediumText(
                                                                              AppLocalizations.of(context)!.hidereport,
                                                                              15,
                                                                              Color(0xFF15294B))),
                                                                    ],
                                                                  ),
                      ...
                      child: Container(
                        ...
                        child: PageView.builder(
                          ...
                          itemBuilder: (context, i) => CachedNetworkImage(
                            imageUrl: images.elementAt(i).toString(),
                            height: MediaQuery.of(context).size.height * 0.6,
                            width: MediaQuery.of(context).size.width,
                            fit: BoxFit.cover,
                            progressIndicatorBuilder:
