...
class ResetPassword_Screen extends StatefulWidget {
  String token="";
  ResetPassword_Screen({required this.token});
...
class _ResetPassword_ScreenState extends State<ResetPassword_Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaKey,
      appBar: AppBar(title: addMediumText(AppLocalizations.of(context)!.resetpassword, 18, Colorss.mainColor),centerTitle: true,backgroundColor: Colors.transparent,elevation: 0,leading:
      InkWell(
      ...
      bottomNavigationBar: !isLoad?(isTrue && isConfirmTrue)?InkWell(
        splashColor: Colors.transparent,
        focusColor: Colors.transparent,
        hoverColor: Colors.transparent,
        highlightColor: Colors.transparent,
        onTap: ()async{
          if (_formKey.currentState!.validate()) {
            ...
            if(newpasswordController.text == confirmpasswordController.text)
              {
                var model=await auth.resetPassword(newpasswordController.text, widget.token, confirmpasswordController.text);
        ...
        child: Container(
          ...
          child: addMediumText(AppLocalizations.of(context)!.resetlogin, 14, Color(0xFFFFFFFF))
        ),
      ):Container(
        height: 70.h,
        ...
        decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(50.r)),
        alignment: Alignment.center,
        child: addMediumText(AppLocalizations.of(context)!.resetlogin, 14, Color(0xFFC2A3DD))
