  ...
  if (message.notification != null) {
    ...
    if(message.data['type']=="profile_visitors"){
      ...
      if(profiledetails != null)
      {
        ...
        languageList: profiledetails.data!.userfilterdata!.languages.toString(),
      ...
      if(message != null)
        {
          ...
          await preferences.setString("notifitypename", message.notification!.body.toString().replaceAll("You received a new message from ","").toString());
          ...
          notifitypename=message.notification!.body.toString().replaceAll("You received a new message from ","").toString();
          print(notifitype);
        }
  ...
  FirebaseMessaging.onMessage.listen(
    (message) {
      ...
      if (message.notification != null) {
        ...
        print("message.notification!.body");
        print(message.notification!.body);
        String name =message.notification!.body.toString().replaceAll("You received a new message from ","").toString();
        print("name");
        print(name);
        //print("${message.data}");
