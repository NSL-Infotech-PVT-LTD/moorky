...
import 'package:moorky/zegocloud/items/msg_items/bubble/video_full_page.dart';
import 'package:photo_view/photo_view.dart';
import 'package:video_player/video_player.dart';

class VideoBubble extends StatefulWidget {
  VideoBubble({required this.filelocalPath,required this.time}) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ConstrainedBox(
              constraints: BoxConstraints(maxHeight: 100.0, maxWidth: 80.0),
              child: Container(
