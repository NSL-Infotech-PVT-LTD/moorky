...
import 'dart:io';
import 'package:get/get.dart' as rp;
...
class ProfileRepository {
  static Future<MaritalStatusModel> getmaritalList(String accesstoken) async {
    ...
    var response = await http.post(
      Uri.parse("${AppUrl.baseUrl}api/marital/list"),
      headers: {
  ...
  static Future<LookingForModel> getlookingForList(String accesstoken) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var response = await http.post(
      Uri.parse("${AppUrl.baseUrl}api/looking-for/list"),
      headers: {
        "authorization": "Bearer ${accesstoken.toString()}",
        "X-localization": "${prefs.getString("lang")}"
      },
  ...
  static Future<InterestedModel> getInterestedList(String accesstoken) async {
    ...
    print("${prefs.getString("lang")}");
    var response = await http.post(
      Uri.parse("${AppUrl.baseUrl}api/interests/list"),
      headers: {
        "authorization": "Bearer ${accesstoken.toString()}",
        "X-localization": "${prefs.getString("lang")}"
      },
  ...
  static Future<ProfileDetailModel> updatenametoIntrested(
      String name,
      String dateofbirth,
      String gender,
      int showgender,
    ...
    if (images.length > 0) {
      ...
      request.fields.addAll({
        ...
        "gender": gender,
        "show_gender": showgender.toString(),
        "date_with": datewith,
        "marital_status": maritalStatus,
        "looking_for": lookingFor,
        "biography": biography,
        "interests": intrest.toString(),
        "age": age,
        "imageindex":
            imageindex.toString().replaceAll("[", "").replaceAll("]", ""),
        "gender_id": gender_id,
        "date_with_id": date_with_id
      });
    } else {
      request.fields.addAll({
        "name": name,
  ...
  static Future<ProfileDetailModel> updateProfile(
      String value, String key, String accesstoken) async {
    print("key");
    print(key);
    print("value");
    print(value);
    ...
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var response = await http.post(
      Uri.parse("${AppUrl.baseUrl}api/profile/create"),
      body: apiBodyData,
      headers: {
        "authorization": "Bearer ${accesstoken.toString()}",
        "X-localization": "${prefs.getString("lang")}"
  ...
  static Future<ProfileDetailModel> updateGhost(
      String value, String key, String accesstoken) async {
    final Map<String, dynamic> apiBodyData = {
      '$key': value,
    };
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var response = await http.post(
      Uri.parse("${AppUrl.baseUrl}api/ghost-mode/update"),
      body: apiBodyData,
      headers: {
        "authorization": "Bearer ${accesstoken.toString()}",
        "X-localization": "${prefs.getString("lang")}"
  ...
  static Future<ProfileDetailModel> updateWork(
      String jobtitle, String companyname, String accesstoken) async {
    final Map<String, dynamic> apiBodyData = {
      'job_title': jobtitle,
  ...
  static Future<ProfileDetailModel> updateProfileImage(
      List<String> images,
      String accesstoken,
      List<String> imagesIndex,
      List<String> httpIndex,
      List<String> httpImages) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var uri = Uri.parse("${AppUrl.baseUrl}api/profile/create");
    ...
    request.fields.addAll({
      "imageindex":
          imagesIndex.toString().replaceAll("[", "").replaceAll("]", ""),
      "image_orders":
          httpIndex.toString().replaceAll("[", "").replaceAll("]", ""),
      "image_ids": httpImages.toString().replaceAll("[", "").replaceAll("]", "")
    });
    request.headers.addAll({
      "authorization": "Bearer ${accesstoken.toString()}",
  ...
  static Future<ProfileDetailModel> updateRealImage(
      String images, String accesstoken) async {
    print(images);
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var uri = Uri.parse("${AppUrl.baseUrl}api/profile/create");
    var request = http.MultipartRequest("POST", uri);
    http.MultipartFile multipartFile =
        await http.MultipartFile.fromPath('real_photo', images);
    request.headers.addAll({
      "authorization": "Bearer ${accesstoken.toString()}",
      'X-localization': "${prefs.getString("lang")}"
    });
  ...
  static Future<ProfileDetailModel> profileDetails(String accesstoken) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var response = await http.post(
      Uri.parse("${AppUrl.baseUrl}api/profile/detail"),
      headers: {
        "authorization": "Bearer ${accesstoken.toString()}",
        "X-localization": "${prefs.getString("lang")}"
      },
    ...
    if (response.statusCode == 200) {
      ...
      rp.Get.offAll(Login_Screen());
      return throw (Exception("Not A Verify"));
    }
  }

  static Future<ProfileDetailModel> userprofileDetails(
  ...
  static Future<ReportReasonListModel> userreportReason(
      String accesstoken) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var response = await http.post(
      Uri.parse("${AppUrl.baseUrl}api/report/reasons"),
      headers: {
        "authorization": "Bearer ${accesstoken.toString()}",
        "X-localization": "${prefs.getString("lang")}"
      },
   ...
   Future<bool>userChatOrNot(
    ...
    try {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      var response = await http.post(
        Uri.parse("${AppUrl.baseUrl}api/checkUserMatch"),
        body: {"user_id":userId,
  ...
  static Future<bool> imageDelete(String accesstoken, String image_id) async {
    ...
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var response = await http.post(
      Uri.parse("${AppUrl.baseUrl}api/image/delete"),
      body: apiBodyData,
      headers: {
        "authorization": "Bearer ${accesstoken.toString()}",
        "X-localization": "${prefs.getString("lang")}"
  ...
  static Future<bool> userReport(String accesstoken, String user_id,
      String reason_id, String hide, String reason) async {
    final Map<String, dynamic> apiBodyData = {
      'user_id': user_id,
    ...
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var response = await http.post(
      Uri.parse("${AppUrl.baseUrl}api/user/report"),
      body: apiBodyData,
      headers: {
        "authorization": "Bearer ${accesstoken.toString()}",
        "X-localization": "${prefs.getString("lang")}"
  ...
  static Future<bool> userHide(String accesstoken, String user_id) async {
    ...
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var response = await http.post(
      Uri.parse("${AppUrl.baseUrl}api/user/hide"),
      body: apiBodyData,
      headers: {
        "authorization": "Bearer ${accesstoken.toString()}",
        "X-localization": "${prefs.getString("lang")}"
  ...
  static Future<ProfileDetailModel> userQuestionDelete(
      String accesstoken, String question_id) async {
    final Map<String, dynamic> apiBodyData = {
      'question_id': question_id,
    };
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var response = await http.post(
      Uri.parse("${AppUrl.baseUrl}api/user/question/delete"),
      body: apiBodyData,
      headers: {
        "authorization": "Bearer ${accesstoken.toString()}",
        "X-localization": "${prefs.getString("lang")}"
