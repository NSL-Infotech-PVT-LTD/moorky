...
class StarSignScreen extends StatefulWidget {
  ...
  bool back=false;
  bool skip=false;
  StarSignScreen({required this.isEdit,required this.starsigntext,required this.back});
  @override
...
class _StarSignScreenState extends State<StarSignScreen> {
  ...
  void Init() async {
    ...
    {
      quizprovider.fetchStarSignList(preferences!.getString("accesstoken").toString());
    }
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: addSemiBoldText(AppLocalizations.of(context)!.whatstarsign,18, Colorss.mainColor)
                    ),
                    SizedBox(
                      height: 20.sp,
                    ),
                    Expanded(
                      child: Consumer<QuizProvider>(
                          builder: (context, quizprovider, child) => quizprovider.starsignList?.data != null?
                          ListView.builder(
                            itemCount: quizprovider.starsignList!.data!.length,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            physics: ScrollPhysics(),
                            itemBuilder: (BuildContext context, int index) {
                              for(int i=0;i<quizprovider.starsignList!.data!.length;i++)
                              {
                                if(quizprovider.starsignList!.data!.elementAt(index).name.toString()==widget.starsigntext)
                                {
                                  quizprovider.starsignList!.data!.elementAt(index).isSelected=true;
                                  star_sign_id=quizprovider.starsignList!.data!.elementAt(index).id!;
                                }
                              }
                              return Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    addRegularText(quizprovider.starsignList!.data!.elementAt(index).name!, 12, Color(0xFF15294B)),
                                    Checkbox(
                                      shape: RoundedRectangleBorder(
                                          borderRadius: BorderRadius.all(
                                              Radius.circular(5.0.r))),
                                      activeColor: Colorss.mainColor,
                                      value: quizprovider.starsignList!.data!.elementAt(index).isSelected==null?false:quizprovider.starsignList!.data!.elementAt(index).isSelected,
                                      onChanged: (value) {
                                        setState(() {
                                          setState(() {
                                            for(int i=0;i<quizprovider.starsignList!.data!.length;i++)
                                            {
                                              if(quizprovider.starsignList!.data!.elementAt(i).isSelected==true)
                                              {
                                                quizprovider.starsignList!.data!.elementAt(i).isSelected=false;
                                              }
                                              widget.starsigntext=quizprovider.starsignList!.data!.elementAt(index).name!;
                                              star_sign_id=quizprovider.starsignList!.data!.elementAt(index).id!;
                                              quizprovider.starsignList!.data!.elementAt(index).isSelected = value;
                                            }
                                          });
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            onBoardProgress(180.w),
                            widget.starsigntext!=""?GestureDetector(
                                onTap: ()async {
                                  setState(() {
                                    isLoad=true;
                                  });
                                  var model=await ProfileRepository.updateProfile(star_sign_id.toString(), "star_sign", preferences!.getString("accesstoken")!);
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        onBoardProgress(180.w),
                        widget.starsigntext!=""?Row(
                          mainAxisAlignment: MainAxisAlignment.end,
                          children: [
                            GestureDetector(
                                onTap: () {
                                  preferences!.setString("starsigntext", star_sign_id.toString());
                                  Navigator.push(context,
                                      MaterialPageRoute(builder:
                                          (context) =>
                                          PetScreen(isEdit: false,petstext: "",back: true,)
                                      )
                                  );
                                },
                                child:
